...
variable "existing_vpc_id" {
  type        = string
  description = "The ID of an existing VPC to use. If not provided, a new VPC will be created."
  default     = null
}

variable "existing_cluster_id" {
  type        = string
  description = "The ID of an existing OpenShift cluster to use. If not provided, a new cluster will be created."
  default     = null
}
